        ...
        >
            <motion.div className="relative transform-3d w-full max-w-4xl" style={{ rotateX, rotateY }} >
                <motion.img src={heroImg}
                    className="border border-blue-800/60 bg-black p-1 w-full rounded-[15px] shadow-[0_0_60px_-15px_rgba(37,99,235,0.5)] will-change-transform transform-[translateZ(0)]"
